...
Unread messages have a blue dot and stronger subject text. Opening a message records it as read, while the blue left border continues to identify the message currently selected. The read state is retained across browser sessions and included in backups.
